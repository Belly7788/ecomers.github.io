...
<html
  ...
  <head>
    ...
    <style>
        .swal2-container {
            z-index: 9999 !important; /* Ensure SweetAlert2 is above all elements */
        }
    </style>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/logos/list" class="menu-link">
                    <div data-i18n="Without menu">View Post</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/logos/add" class="menu-link">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/brands/list" class="menu-link">
                    <div data-i18n="Without menu">View Brands</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/brands/add" class="menu-link">
                    <div data-i18n="Without menu">Add Brands</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/colors/list" class="menu-link">
                    <div data-i18n="Without menu">View colors</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/colors/add" class="menu-link">
                    <div data-i18n="Without menu">Add colors</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-bolt-circle"></i>
                <div data-i18n="Layouts">Sizes</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/sizes/list" class="menu-link">
                    <div data-i18n="Without menu">View Sizes</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/sizes/add" class="menu-link">
                    <div data-i18n="Without menu">Add Sizes</div>
                  </a>
                </li>
              </ul>
            </li>
